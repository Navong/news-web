...
export default function CategorySelector() {
    ...
    return (
        <div className="relative max-w-full px-4 sm:px-6 lg:px-8">
            <button
                onClick={() => scroll('left')}
                className={`absolute left-2 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full bg-gray-800 text-white shadow-lg hover:bg-gray-700 transition-opacity duration-200 ${showLeftScroll ? 'opacity-100' : 'opacity-0 pointer-events-none'
                    }`}
            ...
            <button
                ...
                className={`absolute right-2 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full bg-gray-800 text-white shadow-lg hover:bg-gray-700 transition-opacity duration-200 ${showRightScroll ? 'opacity-100' : 'opacity-0 pointer-events-none'
                    }`}
